...
const INITIAL_TREATMENTS_SEED: TreatmentType[] = [
  {
    ...
    description:
      "Hands-on clinical techniques including Maitland and Mulligan joint mobilizations, passive ROM, and deep myofascial release.",
    durationMinutes: 45,
    defaultPrice: 75,
    status: "Active",
  ...
  },
  {
    ...
    description:
      "High-frequency acoustic sound waves to increase local blood flow, accelerate soft-tissue healing, and break down scar tissue.",
    durationMinutes: 30,
    defaultPrice: 50,
    status: "Active",
  ...
  },
  {
    ...
    category: "Electrotherapy",
    description:
      "Medium frequency electro-stimulation targeting deep-seated nerve pain, edema reduction, and neuromuscular pain suppression.",
    durationMinutes: 30,
    defaultPrice: 45,
    status: "Active",
  ...
  },
  {
    ...
    description:
      "Computerized cyclic and static spinal decompression therapy for herniated discs, radiculopathy, and nerve root impingement.",
    durationMinutes: 40,
    defaultPrice: 85,
    status: "Active",
    requiredEquipment: [
      "Spinal Decompression Table",
      "Thoracic/Pelvic Harness",
    ],
  },
  {
    id: "tt_5",
    ...
    category: "Specialized Rehabilitation",
    description:
      "Sterile filament needles inserted into hyperirritable taut muscular bands to release chronic spasm and deactivate pain pathways.",
    durationMinutes: 45,
    defaultPrice: 90,
    status: "Active",
    requiredEquipment: [
  ...
  },
  {
    ...
    category: "Manual Therapy",
    description:
      "Elastic therapeutic taping application to facilitate lymphatic drainage, support vulnerable ligaments, and enhance proprioception.",
    durationMinutes: 20,
    defaultPrice: 35,
    status: "Active",
  ...
  },
  {
    ...
    description:
      "One-on-one guided clinical corrective exercise therapy aiming for progressive overload and neuromuscular re-education.",
    durationMinutes: 60,
    defaultPrice: 80,
    status: "Active",
...
const INITIAL_EXERCISES_SEED: Exercise[] = [
  {
    ...
    precautions:
      "Avoid if experiencing sharp disc pinching or radiating leg pain during flexion.",
  },
  {
    id: "ex_2",
    ...
    precautions:
      "Do not overarch the lower back; ensure glutes do the primary lifting.",
  },
  {
    id: "ex_3",
    ...
    precautions:
      "Do not allow the lower back to sag. Maintain abdominal tension throughout.",
  },
  {
    id: "ex_4",
  ...
  },
  {
    ...
    precautions:
      "Perform within reach of a wall or stable railing to prevent falls.",
  },
  {
    id: "ex_8",
    ...
    precautions:
      "Ideal for posterior disc derangement; stop if symptoms peripheralize down into legs.",
  },
];
...
const getTreatmentsStore = (): TreatmentType[] => {
  ...
  if (!raw) {
    localStorage.setItem(
      STORAGE_KEY_TREATMENTS,
      JSON.stringify(INITIAL_TREATMENTS_SEED),
    );
...
const getExercisesStore = (): Exercise[] => {
  ...
  if (!raw) {
    localStorage.setItem(
      ...
      JSON.stringify(INITIAL_EXERCISES_SEED),
    );
...
export const treatmentService = {
  ...
  updateExercise: async (
    ...
    const payload = {
      ...
      name: data.title || "",
      description:
        data.precautions || data.targetMuscleGroup || data.title || "",
      instructions: Array.isArray(data.instructions)
        ? data.instructions.join("\n")
        : data.instructions || "",
      videoUrl: data.videoUrl || "",
